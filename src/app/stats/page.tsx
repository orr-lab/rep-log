    ...
    return (
      <div className="mx-auto max-w-3xl px-4 py-16">
        <EmptyState
          ...
          description={
            isOwner
              ? "Log a few sets and your progress charts will show up here."
    ...
    <div className="mx-auto max-w-5xl space-y-10 px-4 py-8">
      <div>
        ...
        <p className="text-muted-foreground">
          {isOwner ? "The long view of your training." : "The long view of training here."}
        </p>
      </div>
          ...
          <div className="rounded-xl border p-4">
            {tagBreakdown.length > 0 ? (
              ...
              <p className="py-8 text-center text-sm text-muted-foreground">
                {isOwner
                  ? "Add tags to your entries to see a breakdown here."
                  : "No tags logged yet."}
              </p>
            )}
          </div>
